                    ...
                    <div className="col-lg-6 my-2 relative">
                        ...
                        <div className={'projectbox reveall py-5 px-3'}>
                            <div className={'project-arrow'}>
                                <a className={'project-link'} href={'/My-Portfolio/home'}>→</a>
                            </div>
                            ...
                            <ul className={'dev-icons d-flex'}>
                                ...
                                <a href={'/My-Portfolio/home'}><li className={'m-2'}>Cloud Security</li></a>
                                <a href={'/My-Portfolio/home'}><li className={'m-2'}>Final certificate</li></a>
                            </ul>
